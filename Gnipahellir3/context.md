...
- **Recent HEAD:** storage barrel + smelter wood-fuel + drag-to-drop ground piles + shaft-mouth loam art (this commit). Also carries Glenn's playtest tweak: **basic wand reach 2 → 3** (`wand_mine_range`, mining.odin — his edit, reformatted to tabs). Prior: player-permeable door + the 2026-08-02 polish/mechanics pass. Not yet pushed (Glenn drives git).
...
E interact (portal/ritual/empty silo/open station/open barrel) · ESC close windows / pause · F1 debug menu · F3 debug overlay.
