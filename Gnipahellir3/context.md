...
- **Mining:** Pickaxe (adjacent, direction-aimed not tile-aimed, 3 chips, free) → wand ladder Mine(2)→Silver(4)→Gold(8)→Runic(12), 5 mana/shot. **Pickaxe horizontal swing mines the body tile nearer the cursor first.** **Bare hands (no pickaxe) can still knock down trees — Wood tiles only, at `BARE_HAND_MULT`=3× the hits (9); no other tile yields to fists** (2026-08-02).
