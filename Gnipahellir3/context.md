...
- **Branch:** master · **Build:** green (`odin build src`) · **Tests:** 205 green (`odin test src -all-packages`)
...
E interact (portal/ritual/rune scroll chest/empty silo/open station/open barrel) · **Shift+hold L-click** = deliberate 0.8 s reclaim of any equipment *including an emptied rune scroll chest* (pickaxe, adjacent; drops as a ground pile) · ESC close windows / pause · F1 debug menu · F3 debug overlay.
