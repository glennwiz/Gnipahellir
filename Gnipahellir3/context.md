...
- **2026-08-04 natural-tree art pass** (146 tests): natural Wood/Leaves now render as a connected silhouette without changing their collision cells (`render.odin`) — narrower knotty amber trunks, branch forks, stepped roots, and overlapping dark-edged leaf clumps replace the old rectangular tile stack. Player-placed and falling wood/leaves intentionally keep square block art. Generated style guide saved at `sprites/tree_concept.png`.
