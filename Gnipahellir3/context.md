...
6. **`blueprints.md`** — blueprints A/B/C now read apart by **seal color** (bronze/silver/gold, matching each ritual's material cost — icon wax, ground/table swatch, and pulse glow, 2026-08-02); still owed distinct **silhouettes** + ritual particles if they want to go further.
