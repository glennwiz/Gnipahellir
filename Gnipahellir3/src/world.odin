...
terrain_table := [Tile_Type]Terrain_Behavior{
    ...
    .Leaves         = { "Leaves",        {.Walkable, .Flammable},                                    rl.Color{0,   180, 0,   200}, 1,   0,   .Leaf          },
    ...
    .Crafting_Bench = { "Crafting Bench",{.Solid, .Placeable},                                       rl.Color{160, 120, 60,  255}, 0,   0,   .Crafting_Bench},
    .Tree_Grower    = { "Tree Grower",   {.Solid, .Placeable},                                       rl.Color{0,   140, 0,   255}, 0,   0,   .Tree_Grower   },
    .Smelter        = { "Smelter",       {.Solid, .Placeable},                                       rl.Color{200, 100, 0,   255}, 0,   0,   .Smelter       },
