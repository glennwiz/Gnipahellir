...
terrain_table := [Tile_Type]Terrain_Behavior{
    ...
    .Grass          = { "Grass",         {.Solid, .Mineable},                                        rl.Color{34,  139, 34,  255}, 0,   0,   .Grass_Turf    , 0 },
    .Stone          = { "Stone",         {.Solid, .Mineable},                                        rl.Color{128, 128, 128, 255}, 0,   0,   .Stone_Block   , 0 },
    .Water          = { "Water",         {.Walkable, .Swimmable},                                    rl.Color{30,  100, 200, 200}, 2,   0,   .None          , 0 },
    .Lava           = { "Lava",          {.Walkable, .Damaging},                                     rl.Color{220, 80,  0,   255}, 2,   2,   .None          , 0 },
    .Magic_Lava     = { "Magic Lava",    {.Walkable, .Damaging},                                     rl.Color{160, 0,   220, 255}, 2,   4,   .None          , 0 },
    .Wood           = { "Wood",          {.Solid, .Mineable, .Flammable},                            rl.Color{139, 90,  43,  255}, 0,   0,   .Wood_Log      , 0 },
    .Leaves         = { "Leaves",        {.Walkable, .Flammable, .Mineable},                         rl.Color{0,   180, 0,   200}, 1,   0,   .Leaf          , 0 },
    .Iron_Ore       = { "Iron Ore",      {.Solid, .Mineable},                                        rl.Color{180, 130, 100, 255}, 0,   0,   .Iron_Ore      , 0 },
    .Silver_Ore     = { "Silver Ore",    {.Solid, .Mineable},                                        rl.Color{200, 200, 220, 255}, 0,   0,   .Silver_Ore    , 0 },
    .Gold_Ore       = { "Gold Ore",      {.Solid, .Mineable},                                        rl.Color{220, 180, 0,   255}, 0,   0,   .Gold_Ore      , 0 },
    .Gold_Rare_Ore  = { "Rare Gold Ore", {.Solid, .Mineable},                                        rl.Color{255, 215, 50,  255}, 0,   0,   .Gold_Rare_Ore , 0 },
    .Crafting_Bench = { "Crafting Bench",{.Solid, .Placeable, .Mineable},                             rl.Color{160, 120, 60,  255}, 0,   0,   .Crafting_Bench, 0 },
    .Tree_Grower    = { "Tree Grower",   {.Solid, .Placeable, .Mineable},                             rl.Color{0,   140, 0,   255}, 0,   0,   .Tree_Grower   , 0 },
    .Smelter        = { "Smelter",       {.Solid, .Placeable, .Mineable},                             rl.Color{200, 100, 0,   255}, 0,   0,   .Smelter       , 0 },
    .Cave_Entrance  = { "Cave Entrance", {.Walkable},                                                rl.Color{60,  0,   80,  255}, 1,   0,   .None          , 0 },
    .Sky_Entrance   = { "Sky Entrance",  {.Walkable},                                                rl.Color{180, 220, 255, 255}, 1,   0,   .None          , 0 },
    .Sky_Altar      = { "Sky Altar",     {.Solid, .Placeable, .Mineable},                             rl.Color{200, 200, 255, 255}, 0,   0,   .Sky_Altar     , 0 },
    .Cloud          = { "Cloud",         {.Solid, .Mineable},                                        rl.Color{240, 240, 255, 200}, 0,   0,   .Cloud_Stone, 20 },
    .Cloud_Ore      = { "Cloud Ore",     {.Solid, .Mineable},                                        rl.Color{200, 220, 255, 255}, 0,   0,   .Cloud_Stone   , 0 },
    .Aether_Ore     = { "Aether Ore",    {.Solid, .Mineable},                                        rl.Color{180, 255, 200, 255}, 0,   0,   .Aether_Crystal, 0 },
    .Runic_Sky_Ore  = { "Runic Sky Ore", {.Solid, .Mineable},                                        rl.Color{255, 180, 255, 255}, 0,   0,   .Runic_Sky_Ore , 0 },
    .Wind_Current   = { "Wind Current",  {.Walkable},                                                rl.Color{200, 240, 255, 150}, 1,   0,   .None          , 0 },
    .Void_Sky       = { "Void Sky",      {.Walkable, .Damaging},                                     rl.Color{0,   0,   0,   255}, 1,   1,   .None          , 0 },
    .Flower         = { "Flower",        {.Walkable},                                                 rl.Color{255, 220,  50, 255}, 1,   0,   .None          , 0 },
    .Dvergr_Forge   = { "Dvergr Forge",  {.Solid, .Placeable, .Mineable},                             rl.Color{105, 105, 125, 255}, 0,   0,   .Dvergr_Forge  , 0 },
    .Rune_Altar     = { "Rune Altar",    {.Solid, .Placeable, .Mineable},                             rl.Color{150, 90,  220, 255}, 0,   0,   .Rune_Altar    , 0 },
    .Dimension_Spawner = { "Metal Dimension Spawner", {.Solid, .Placeable, .Mineable},                rl.Color{40,  200, 180, 255}, 0,   0,   .Dimension_Spawner , 0 },
    .Dimension_Gate    = { "Dimension Gate",    {.Walkable},                                          rl.Color{30,  140, 130, 255}, 1,   0,   .None              , 0 },
    .Dimension_Spawner_Gold = { "Gold Dimension Spawner", {.Solid, .Placeable, .Mineable},            rl.Color{235, 195, 60,  255}, 0,   0,   .Dimension_Spawner_Gold , 0 },
    .Emerald_Ore    = { "Emerald Ore",   {.Solid, .Mineable},                                        rl.Color{50,  205, 120, 255}, 0,   0,   .Emerald       , 0 },
    .Jade_Ore       = { "Jade Ore",      {.Solid, .Mineable},                                        rl.Color{150, 210, 165, 255}, 0,   0,   .Jade          , 0 },
    .Diamond_Ore    = { "Diamond Ore",   {.Solid, .Mineable},                                        rl.Color{190, 235, 255, 255}, 0,   0,   .Diamond       , 0 },
    .Hel_Gem_Ore    = { "Hel Gem Ore",   {.Solid, .Mineable},                                        rl.Color{200, 30,  70,  255}, 0,   0,   .Hel_Gem       , 0 },
